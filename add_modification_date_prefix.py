...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Add modification date as prefix to filenames in a directory.')
    parser.add_argument('directory', type=str, help='The path to the directory containing files to rename.')
